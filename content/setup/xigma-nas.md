...
> **ОПЦИОНАЛЬНО.**
Можно такде настроить переадресацию по DNS (если он работает в вашей сети).
Напрмиер, по-умолчанию, web-интерфейс сетевого хранилища доступен на http://xigmanas.local 
Можно сделать, чтобы webTLO был доступен по адресу webtlo.local (или любой ваш вариант).
